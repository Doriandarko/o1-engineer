...
CREATE_SYSTEM_PROMPT = """You are an advanced Grok engineer designed to create files and folders based on user instructions. Your primary objective is to generate the content of the files to be created as code blocks. Each code block should specify whether it's a file or folder, along with its path.
...
EDIT_INSTRUCTION_PROMPT = """You are an advanced Grok engineer designed to analyze files and provide edit instructions based on user requests. Your task is to:
...
def chat_with_ai(user_message, is_edit_request=False, retry_count=0, added_files=None):
    ...
    try:
        ...
        if is_edit_request and retry_count == 0:
            ...
            print(colored("Grok engineer is thinking...", "magenta"))
...
def main():
    ...
    print(colored("Grok is ready to help you.", "cyan"))
    print("\nAvailable commands:")
...
"""
            ...
            if ai_response:
                print("Grok engineer: Here are the suggested edit instructions:")
            ...
            if ai_response:
                while True:
                    print("Grok engineer: Here is the suggested creation structure:")
                    rprint(Markdown(ai_response))
            ...
            if ai_response:
                print()
                print(colored("Grok engineer: Here is your detailed plan:", "blue"))
                rprint(Markdown(ai_response))
            ...
            if ai_response:
                print()
                print(colored("Grok engineer:", "blue"))
                rprint(Markdown(ai_response))
